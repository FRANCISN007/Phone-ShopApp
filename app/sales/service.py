...
def create_sale_full(
    ...
    Each item can have a discount entered manually.
    """
    warnings = []
    ...
    for item in sale_data.items:
        ...
        discount = getattr(item, "discount", 0)  # allow optional discount
        ...
        sale_item = models.SaleItem(
            ...
            total_amount=net_amount  # total_amount = net_amount for now
        )
...
def create_sale_item(db: Session, item: schemas.SaleItemCreate):
    ...
    Discount can be supplied manually.
    """
