...
def create_sale_full(
    ...
    # 1️⃣ Create Sale Header (invoice_no is GENERATED by DB)
    sale = models.Sale(
    ...
    db.add(sale)
    db.commit()
    db.refresh(sale)  # ✅ invoice_no is now available
